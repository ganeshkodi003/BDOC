...
public class paystructureentity {
	...
	private BigDecimal cum_tax_dud;
	public BigDecimal getCum_tax_dud() {
		return cum_tax_dud;
	}
	public void setCum_tax_dud(BigDecimal cum_tax_dud) {
		this.cum_tax_dud = cum_tax_dud;
	}
	...
	public paystructureentity(String branchId) {
		super();
		this.branchId = branchId;
	}
	public paystructureentity(String emp_no, String emp_name, String emp_desig, String emp_group, String emp_division,
			...
			String del_flg, String pay_status, Date entry_time, String entry_user, String modify_flg,String verify_flg, Date modify_time,
			String modify_user, Date verify_time, String verify_user, String ifsc_code, String remarks,
			String aadhar_no,String	national,String	group_of_ctc,BigDecimal cum_tax_dud, String org_id) {
		super();
		this.emp_no = emp_no;
		...
		this.group_of_ctc = group_of_ctc;
		this.cum_tax_dud=cum_tax_dud;
		this.org_id=org_id;
	}
	@Override
	public String toString() {
		return "paystructureentity [emp_no=" + emp_no + ", emp_name=" + emp_name + ", emp_desig=" + emp_desig
				...
				+ entry_user + ", modify_flg=" + ", verify_flg=" + modify_flg + ", modify_time=" + modify_time + ", modify_user="
				+ modify_user + ", verify_time=" + verify_time + ", verify_user=" + verify_user + ", ifsc_code="
				+ ifsc_code + ", remarks=" + remarks + ", aadhar_no=" + aadhar_no + ", national=" + national +", cum_tax_dud=" + cum_tax_dud +", group_of_ctc=" + group_of_ctc + "]";
	}
	
	
	
	public String getGroup_of_ctc() {
		return group_of_ctc;
	}
	public void setGroup_of_ctc(String group_of_ctc) {
		this.group_of_ctc = group_of_ctc;
	}
