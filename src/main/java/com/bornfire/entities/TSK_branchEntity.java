...
@Entity
@Table(name = "TSK_BRANCH_TABLE")
public class TSK_branchEntity {
	@Id
	...
	public TSK_branchEntity(String branchId, String branchName, String landline1, String landline2, String mobileNo,
			String alternateMobileNo, String addressLine1, String addressLine2, String city, String state,
			String country, String postalCode, String entryUser, String modifyUser, String delFlg,String org_name,String org_id) {
		super();
		this.branchId = branchId;
		this.branchName = branchName;
		this.landline1 = landline1;
