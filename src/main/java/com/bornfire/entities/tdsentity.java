...
public class tdsentity {
	...
	public tdsentity(String emp_name, String emp_desig, String emp_group, String pan_no, Date date_of_birth,
			...
			Date verify_time, String verify_user, String remarks, String aadhar_no, String rate_of_tds,
			String uniqueids, String emp_no) {
		super();
	...
	public String toString() {
		return "tdsentity [emp_name=" + emp_name + ", emp_desig=" + emp_desig + ", emp_group=" + emp_group + ", pan_no="
				...
				+ ", rate_of_tds=" + rate_of_tds + ", uniqueids=" + uniqueids + ", emp_no=" + emp_no + "]";
	}
