...
@Entity
@Table(name = "BGLS_BUSINESS_TABLE" )
public class BGLSBusinessTable_Entity {
	...
	public BGLSBusinessTable_Entity(String audit_ref_no, Date audit_date, String audit_table, String audit_screen,
	...
	public BGLSBusinessTable_Entity() {
		super();
