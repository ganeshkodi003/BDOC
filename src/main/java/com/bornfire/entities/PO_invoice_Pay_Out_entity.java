...
@Entity
@Table(name = "PO_INVOICE_TABLE_PAY_OUT")
public class PO_invoice_Pay_Out_entity {
	...
	public PO_invoice_Pay_Out_entity(String id, String poId, String vendorId, String itemcode, Date orderDate,
			...
			String referenceNumber, BigDecimal paidAmount, Character entityFlg, Character verifyFlg,
			Character modifyFlg, Character delFlg, Character inventoryFlg, Character qcFlg, Character approvedFlg,
			String verifyTime, String verifyUser, String entryUser, String entryTime, String assetType,
			String assetCategory, String assetSubcategory, String orderNo, String hsncode, String batch,
			Integer useingqty, String assetcode, String vendor_name, BigDecimal buy_Amount,
			BigDecimal total_vendor_balance,String branchId) {
		super();
		this.id = id;
		this.poId = poId;
		this.vendorId = vendorId;
	...
	public PO_invoice_Pay_Out_entity() {
		super();
