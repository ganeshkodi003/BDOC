...
@Entity
@Table(name = "BDOC_USER_PROFILE")
public class BDOCUserProfile implements UserDetails {
	...
	public String toString() {
		return "UserProfile [bank_code=" + bank_code + ", bank_name=" + bank_name + ", branch_code=" + branch_code
				...
				+ ", getNew_user_flg()=" + getNew_user_flg() + ", getAuthorities()=" + getAuthorities()
	...
	public BDOCUserProfile(String bank_code, String bank_name, String branch_code, String branch_name, String empid,
	...
	public BDOCUserProfile get() {
		// TODO Auto-generated method stub
		return null;
	}

	public BDOCUserProfile(BDOCUserProfileMod userProfile) {
