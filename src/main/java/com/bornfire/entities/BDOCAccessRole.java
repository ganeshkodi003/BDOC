...
@Entity
@Table(name = "BDOC_ACCESS_ROLE_TABLE")
public class BDOCAccessRole {
	...
	public BDOCAccessRole(String role_id, String role_desc, String permissions, String work_class,
	...
	public BDOCAccessRole(BDOCAccessRoleModTable ipsAccessRole) {
