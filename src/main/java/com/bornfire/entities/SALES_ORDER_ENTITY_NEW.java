...
@Entity
@Table(name = "SALES_ORDER_TABLE_NEW")
public class SALES_ORDER_ENTITY_NEW {
	  ...
	  @Id
	   ...
	   @Column(name = "saletype", length = 100)
	...
	public SALES_ORDER_ENTITY_NEW(String id, String woId, String vendorId, String itemcode, Date orderDate,
			...
			String assetSubcategory, String hsncode, String sHIPPING_ADDRESS, String phone_no, String bill_companyname,
			...
			String ship_phno, String bill_email, String ship_email, String bill_gstno, String ship_gstno,
			String orderNo, String saletype, String vendor_name,String branchId) {
		super();
		this.id = id;
		this.woId = woId;
		this.vendorId = vendorId;
