...
@Entity
@Table(name = "PO_DEMO_TABLE")
public class Transaction_table_demo {
	@Id
	  @Column(name = "TRAN_ID", nullable = false, unique = true, length = 50)
	...
	public Transaction_table_demo(String tran_id, String classification, String acct_type, String gl_code,
			String gl_desc, String glsh_code, String glsh_desc, String schm_type, String schm_code, String acct_num,
			String acct_name, String add_det_flg, String acct_partition, String acct_crncy, String ref_crncy,
			String ref_code, String ref_desc, String rpt_code, String acct_status, BigDecimal cr_amt, BigDecimal dr_amt,
			BigDecimal acct_bal, BigDecimal ref_crncy_bal, String entry_user, Date entry_time, String modify_user,
			Date modify_time, String auth_user, Date auth_time, String entity_flg, String del_flg, String acct_cls_flg,
			...
			String branch_id, Date acct_open_date, String national_id, BigDecimal mobile_no, String vendor_id,
			String po_id, String wo_id, BigDecimal capital_amt, String tran_type, String type) {
		super();
		this.tran_id = tran_id;
		this.classification = classification;
		this.acct_type = acct_type;
