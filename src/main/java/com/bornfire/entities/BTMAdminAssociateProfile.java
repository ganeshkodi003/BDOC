...
public class BTMAdminAssociateProfile {
	...
	@Lob
	@Column(name = "Aadharfile", length = 100)
	...
	private String slcfilename;
	private String hscdocumentfilename;
	private String ugdocumenfilename;
	private String diplomafilename;
	private String pgdocumentfilename;
	
	@Lob
	@Column(name = "PanCardfile", length = 100)
	private byte[] pancardfile; 
	
	@Lob
	@Column(name = "Passportfile", length = 100)
	private byte[] passportfile; 
	
	@Lob
	@Column(name = "DrivingLicense", length = 100)
	private byte[] drivinglicense; 
	
	@Lob
	@Column(name = "SLC", length = 100)
	private byte[] slc;
	
	@Lob
	@Column(name = "HSCdocumentfile", length = 100)
	private byte[] hscdocumentfile;
	
	@Lob
	@Column(name = "UGdocumentfile", length = 100)
	private byte[] ugdocumentfile; 
	
	@Lob
	@Column(name = "Diplomafile", length = 100)
	private byte[] diplomafile; 
	
	@Lob
	@Column(name = "pgdocumentfile", length = 100)
	private byte[] pgdocumentfile;
	   ...
	   @Column(name = "CASUAL_LEAVE")
	    ...
	    @Column(name = "YEARLY_LEAVE")
	    private Long yearlyLeave;
	    
	    @Column(name = "CL_LEAVE_BALANCE")
	    private Long clLeaveBalance;

	    @Column(name = "SL_LEAVE_BALANCE")
	    private Long slLeaveBalance;

	    @Column(name = "ML_LEAVE_BALANCE")
	    private Long mlLeaveBalance;

	    @Column(name = "PL_LEAVE_BALANCE")
	    private Long plLeaveBalance;

	    @Column(name = "YL_LEAVE_BALANCE")
	    private Long ylLeaveBalance;
	    
	    @Column(name = "used_flg", length = 1)
		...
		public BTMAdminAssociateProfile(String branchId,String org_id) {
			super();
			this.branchId = branchId;
			this.org_id=org_id;
		}
		...
		public String getDrivinglicensefilename() {
			return drivinglicensefilename;
		}

		public void setDrivinglicensefilename(String drivinglicensefilename) {
			this.drivinglicensefilename = drivinglicensefilename;
		}

		public String getSlcfilename() {
			return slcfilename;
		}

		public void setSlcfilename(String slcfilename) {
			this.slcfilename = slcfilename;
		}

		public String getHscdocumentfilename() {
			return hscdocumentfilename;
		}

		public void setHscdocumentfilename(String hscdocumentfilename) {
			this.hscdocumentfilename = hscdocumentfilename;
		}

		public String getUgdocumenfilename() {
			return ugdocumenfilename;
		}

		public void setUgdocumenfilename(String ugdocumenfilename) {
			this.ugdocumenfilename = ugdocumenfilename;
		}
		...
		public String getPgdocumentfilename() {
			return pgdocumentfilename;
		}

		public void setPgdocumentfilename(String pgdocumentfilename) {
			this.pgdocumentfilename = pgdocumentfilename;
		}
		...
		public void setSlc(byte[] slc) {
			this.slc = slc;
		}

		public byte[] getHscdocumentfile() {
			return hscdocumentfile;
		}

		public void setHscdocumentfile(byte[] hscdocumentfile) {
			this.hscdocumentfile = hscdocumentfile;
		}

		public byte[] getUgdocumentfile() {
			return ugdocumentfile;
		}

		public void setUgdocumentfile(byte[] ugdocumentfile) {
			this.ugdocumentfile = ugdocumentfile;
		}
		...
		public byte[] getPgdocumentfile() {
			return pgdocumentfile;
		}

		public void setPgdocumentfile(byte[] pgdocumentfile) {
			this.pgdocumentfile = pgdocumentfile;
		}
		...
		public Long getYearlyLeave() {
			return yearlyLeave;
		}

		public void setYearlyLeave(Long yearlyLeave) {
			this.yearlyLeave = yearlyLeave;
		}

		public Long getClLeaveBalance() {
			return clLeaveBalance;
		}

		public void setClLeaveBalance(Long clLeaveBalance) {
			this.clLeaveBalance = clLeaveBalance;
		}

		public Long getSlLeaveBalance() {
			return slLeaveBalance;
		}

		public void setSlLeaveBalance(Long slLeaveBalance) {
			this.slLeaveBalance = slLeaveBalance;
		}

		public Long getMlLeaveBalance() {
			return mlLeaveBalance;
		}

		public void setMlLeaveBalance(Long mlLeaveBalance) {
			this.mlLeaveBalance = mlLeaveBalance;
		}

		public Long getPlLeaveBalance() {
			return plLeaveBalance;
		}

		public void setPlLeaveBalance(Long plLeaveBalance) {
			this.plLeaveBalance = plLeaveBalance;
		}

		public Long getYlLeaveBalance() {
			return ylLeaveBalance;
		}

		public void setYlLeaveBalance(Long ylLeaveBalance) {
			this.ylLeaveBalance = ylLeaveBalance;
		}
		...
		public BTMAdminAssociateProfile(String resource_id, String organisation, String category, String resource_name,
				...
				String del_flg, String entity_flg, String modify_flg, String session_id, String imei, Date dor,
				String ifsc, String bank, String bank_act_no, String personal_email, String fileName, String filetype,
				String aCCOUNT_NUMBER, byte[] files, byte[] aadharfile, String aadharfilename, String panCardfilename,
				String passportfilename, String drivinglicensefilename, String slcfilename, String hscdocumentfilename,
				String ugdocumenfilename, String diplomafilename, String pgdocumentfilename, byte[] pancardfile,
				byte[] passportfile, byte[] drivinglicense, byte[] slc, byte[] hscdocumentfile, byte[] ugdocumentfile,
				byte[] diplomafile, byte[] pgdocumentfile, Long casualLeave, Long sickLeave, Long maternityLeave,
				Long paternityLeave, Long yearlyLeave, Long clLeaveBalance, Long slLeaveBalance, Long mlLeaveBalance,
				Long plLeaveBalance, Long ylLeaveBalance, String usedFlag) {
			super();
			this.resource_id = resource_id;
			this.organisation = organisation;
			this.category = category;
