...
@Entity
@Table(name="BSPF_VIEW")
public class BSPF_ENTITY {
	...
	public BSPF_ENTITY(String emp_no, String emp_name, String emp_desig, Date date_of_birth, Date date_of_join,
			String spf_acct_no, String urn_no, BigDecimal no_of_days, BigDecimal days_paid, String bank_name,
			String bank_acct_no, String salary_month, BigDecimal basic_pay, BigDecimal hra, BigDecimal spl_allow,
			...
			BigDecimal annual_loyal_bonus, BigDecimal otr_allow, BigDecimal gross_salary, BigDecimal spf,
			...
			BigDecimal ctc_amt, BigDecimal mobile_no, String email_id, String ifsc_code, String remarks,
			String adhar_no) {
		super();
		this.emp_no = emp_no;
		this.emp_name = emp_name;
