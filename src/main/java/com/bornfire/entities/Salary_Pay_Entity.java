...
@Entity
@Table(name = "BTM_SAL_STR")
@IdClass(Salary_Pay_Embedded.class)
public class Salary_Pay_Entity {
	...
	public Salary_Pay_Entity(String emp_no, String emp_name, String emp_desig, String emp_group, String emp_division,
			...
			String modify_user, Date verify_time, String verify_user, String ifsc_code, String remarks, byte[] str,
			byte[] revision) {
		super();
		this.emp_no = emp_no;
		this.emp_name = emp_name;
