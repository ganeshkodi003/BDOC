...
@Entity
@Table(name = "SALES_invoice_TABLE")
public class SALES_invoice_TABLE {
	 @Id
	...
	public SALES_invoice_TABLE(String id, String woId, String vendorId, String itemcode, Date orderDate, Date dueDate,
			...
			String hsncode, String orderNo, String shippingaddress, String phoneno, BigDecimal last_extra_amount,
			...
			String vendor_name, BigDecimal usingqty, Date invoice_conform_date, String deliverytype,
			BigDecimal deliverycharge, String deliverystatus, Date deliverydate, String deliverypaymenttype,String branchId) {
		super();
		this.id = id;
		this.woId = woId;
		this.vendorId = vendorId;
