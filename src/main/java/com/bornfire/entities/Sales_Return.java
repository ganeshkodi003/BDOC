...
public class Sales_Return {
	...
	public String getWo_Return_id() {
		return wo_Return_id;
	}
	public void setWo_Return_id(String wo_Return_id) {
		this.wo_Return_id = wo_Return_id;
	}
	...
	public Sales_Return(String id, String woId, String vendorId, String itemcode, Date orderDate, Date dueDate,
			String item, BigDecimal qty, BigDecimal totalQty, String unit, String priceHeader, BigDecimal price,
			String taxPercentage, BigDecimal taxAmount, BigDecimal amountPerItem, BigDecimal totalAmount,
			BigDecimal advanceAmount, BigDecimal balanceAmount, BigDecimal vendorbalance, String paymentType,
			...
			String assetSubcategory, String hsncode, String debit, String credit, String orderNo,
			String sHIPPING_ADDRESS, String phoneno, String bill_companyname, String ship_companyname,
			String bill_address, String ship_address, String bill_street, String ship_street, String bill_dis,
			String ship_dis, String bill_pincode, String ship_pincode, String bill_phno, String ship_phno,
			String bill_email, String ship_email, String bill_gstno, String ship_gstno, String wo_Return_id,
			String batch, String vendor_name, String saletype, Date return_date, String branchId) {
		super();
		this.id = id;
		this.woId = woId;
		this.vendorId = vendorId;
