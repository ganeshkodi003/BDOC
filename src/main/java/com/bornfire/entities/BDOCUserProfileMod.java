...
@Entity
@Table(name = "BDOC_USER_PROFILE_MOD_TABLE")
public class BDOCUserProfileMod implements UserDetails {
	...
	public BDOCUserProfileMod(BDOCUserProfile userProfile) {
	...
	public BDOCUserProfileMod(String bank_code, String bank_name, String branch_code, String branch_name, String empid,
