...
public class TimeSheetBean {
	...
	public TimeSheetBean(TimesheetID timesheetID, String emp_name, String orgn_name, String proj_name,
			...
			String date_21, String date_22, String date_23, String date_24, String entity_flg) {
		super();
		this.timesheetID = timesheetID;
		this.emp_name = emp_name;
		this.orgn_name = orgn_name;
