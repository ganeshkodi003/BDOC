...
@Entity
@Table(name = "BGLS_TRM_WRK_TRANSACTIONS", schema="dbo")
public class TRAN_MAIN_TRM_WRK_ENTITY {
	@Id
	...
	public TRAN_MAIN_TRM_WRK_ENTITY(String srl_no, String branch_id, String acid, String cust_id, String tran_id,
			...
			String flow_code, Date flow_date, String vendor_Id, String vendor_type) {
		super();
		this.srl_no = srl_no;
		this.branch_id = branch_id;
		this.acid = acid;
	...
	public TRAN_MAIN_TRM_WRK_ENTITY() {
		super();
