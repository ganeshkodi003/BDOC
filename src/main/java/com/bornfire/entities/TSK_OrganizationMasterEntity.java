...
@Entity
@Table(name = "TSK_ORGANIZATION_DETAILS")
public class TSK_OrganizationMasterEntity {
	@Id
	private String id;
	...
	public TSK_OrganizationMasterEntity(String id,String org_id,String org_name, String short_name, String regn_no, String gst_ref, Date dor,
	...
	public TSK_OrganizationMasterEntity() {
		super();
