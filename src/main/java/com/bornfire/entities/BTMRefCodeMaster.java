...
public class BTMRefCodeMaster {
	...
	public BTMRefCodeMaster(String ref_type, String ref_type_desc, String ref_id, String ref_id_desc, String module_id,
			String remarks, String entry_user, String modify_user, String auth_user, Date entry_time, Date modify_time,
			Date auth_time, String del_flg, String modify_flg, String entity_flg) {
		super();
		this.ref_type = ref_type;
		this.ref_type_desc = ref_type_desc;
		this.ref_id = ref_id;
