...
@Entity
@Table(name = "SALES_invoice_TABLE_PAY_IN")
public class SALES_invoice_TABLE_PAY_IN {
	 @Id
	...
	public BigDecimal getTotal_vendor_balance() {
		return total_vendor_balance;
	}
	public void setTotal_vendor_balance(BigDecimal total_vendor_balance) {
		this.total_vendor_balance = total_vendor_balance;
	}
		@Column(name = "buy_Amount")
	    private BigDecimal buy_Amount;

	    @Column(name = "Total_vendor_balance")
	    private BigDecimal total_vendor_balance;
	...
	public SALES_invoice_TABLE_PAY_IN(String id, String woId, String vendorId, String itemcode, Date orderDate, Date dueDate,
			...
			String hsncode, String orderNo, String shippingaddress, String phoneno, String bill_companyname,
			String ship_companyname, String bill_address, String ship_address, String bill_street, String ship_street,
			String bill_dis, String ship_dis, String bill_pincode, String ship_pincode, String bill_phno,
			String ship_phno, String bill_email, String ship_email, String bill_gstno, String ship_gstno, String batch,
			String stock, String saletype, String vendor_name, BigDecimal usingqty,BigDecimal buy_Amount,BigDecimal total_vendor_balance,
			String branchId) {
		super();
		this.id = id;
		this.woId = woId;
	...
	public SALES_invoice_TABLE_PAY_IN() {
		super();
